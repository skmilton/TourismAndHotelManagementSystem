                ...
                <div class="card card-authentication1 mb-0">
                    <div class="card-body">
                        <div class="card-content p-2">
                            <div class="card-title text-uppercase pb-2">Tourist Sign Up</div>
                            <p class="pb-2">Please enter your information carefully and confirm your identity.</p>
                            <form>
                                <div class="form-group">
                                    <label for="exampleInputName" class="">Name</label>
                                    <div class="position-relative has-icon-right">
                                        <input type="text" id="exampleInputName" class="form-control input-shadow" placeholder="Name"  name="name" >

                                        <div class="form-control-position">

                                        </div>
                                    </div>
                                    <label for="exampleInputUserName" class="">User Name</label>
                                    <div class="position-relative has-icon-right">
                                        <input type="text" id="exampleInputUserName" class="form-control input-shadow" placeholder="UserName" name="userName">
                                        <div class="form-control-position">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="text" id="exampleInputEmailAddress" class="form-control input-shadow" placeholder="Address" name="address">
                                        <div class="form-control-position">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="text" id="exampleInputMobile" class="form-control input-shadow" placeholder="mMbile" name="mobile">
                                        <div class="form-control-position">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="email" id="exampleInputEmail" class="form-control input-shadow" placeholder="Email" name="email">
                                        <div class="form-control-position">
                                ...
                                <a class="btn btn-light btn-block mt-3" href="/login/signIn">Sign Up</a>
                            </form>
                        </div>
                    </div>
                    <div class="card-footer text-center py-3">
                        <p class="text-warning mb-0">Return to the <a href="/login/signIn"> Sign In</a></p>
                    </div>
                </div>
            </div>
