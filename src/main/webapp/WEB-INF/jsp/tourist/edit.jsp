    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="wizard-content">
                <form class="tab-wizard wizard-circle wizard vertical" action="/tourist/update" method="POST">
                    ...
                    <section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nid :</label>
                                    <input type="text" class="form-control date-picker" placeholder="Nid" name="nid" value="${t.nid}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Joining Date :</label>
                                    <input type="date" class="form-control date-picker" placeholder="Joining Date" name="jDate" value="${t.jDate}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
