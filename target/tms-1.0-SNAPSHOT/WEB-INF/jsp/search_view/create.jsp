                ...
                <div class="col-lg-8 col-md-7 px-0">
                    <div class="map_container">
                        <div class="map-responsive">
                            <iframe src= width="600" height="300" frameborder="0" style="border:0; width: 100%; height:100%" allowfullscreen>
                            ...
                            <div class="container py-3">
                                <div class="row mt-5 text-center">
                                    ...
                                    <div class="col-md-9 py-5">
                                        <h1 class="text-center pb-5">Create Room Booking Package</h1>
                ...
                <div class="col-md-5 col-lg-4 px-0">
                    ...
                    <form action="/contact/save" method="POST">
                        ...
                        <div class="d-flex ">
                            ...
                            <!--                             <button class="btn btn-info btn-sm"><a href="/cart/invoice/${mm.id}"><i class="fa fa-edit" style="font-size:24px;"></i></a>Send</button>
                            -->
                        </div>
                    </form>
                </div>
