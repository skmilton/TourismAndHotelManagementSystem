            ...
            <div class="invoice-box">
                ...
                <div class="row pb-30">
                    <div class="col-md-6">
                        ...
                        <p class="font-14 mb-5">Date Issued: <strong class="weight-600">${map.invoice.invoiceDate}</strong></p>
                        <p class="font-14 mb-5">Room Code:<strong class="weight-600">${map.invoice.roomCode}</strong> </p>
                        <p class="font-14 mb-5">Check In: <strong class="weight-600">${map.invoice.checkIn}</strong></p>
                        <p class="font-14 mb-5">Check Out: <strong class="weight-600">${map.invoice.checkOut}</strong></p>
                    </div>
                    <div class="col-md-6">
                        <div class="text-right">

                            <p class="font-14 mb-5">Invoice No: <strong class="weight-600">${map.invoice.id}</strong></p>
                    ...
                    <div class="invoice-desc-body">
                        <ul>
                            <li class="clearfix">
                                ...
                                <div class="invoice-subtotal"><span class="weight-600">${map.invoice.roomPrice}</span></div>
                            </li>
                        </ul>
                    </div>
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="id" style="">
                                        <div class="invoice-rate font-20 weight-600">  
                                            ...
                                            <p class="font-14"><strong class="weight-600">Discount: ${map.invoice.discount}%</strong></p>
                                            <p class="font-14"><strong class="weight-600">Total :</strong></p>
                                            <p class="font-14"><strong class="weight-600"></strong>Vat:(+)${map.invoice.vat}%</p>
                                        </div>
                                        <div class="invoice-rate font-20 weight-600">
                                            <p class="font-14"><strong class="weight-600">${map.invoice.roomPrice} /=</strong></p>
                                            <p class="font-14"><strong class="weight-600">${map.invoice.tDiscount} /=</strong></p>
                                            <p class="font-14"><strong class="weight-600">${map.invoice.netTotal} /=</strong></p>
                                            <p class="font-14"><strong class="weight-600">${map.invoice.tVat} /=</strong></p>
                                        </div>

                                            <div class="invoice-subtotal"><span class="weight-600 text-danger"><strong style="font-size: 23px"> ${map.invoice.grandTotal} /= </strong></span></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
