    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="wizard-content">
                <form class="tab-wizard wizard-circle wizard vertical" action="/tourManager/save" method="POST">
                    <h1 class="py-5" style="margin-top: 25px">Tour Manager Personal Info</h1>
                    <section>
                        <div class="row">
                            <div class="col-md-6">
