...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="/resources/assets/home/image/Logo.png" type="image/x-icon">
        <!-- Bootstrap core CSS-->
                ...
                <div class="card card-authentication1 mb-0">
                    <div class="card-body">
                        <div class="card-content p-2">
                            <div class="card-title text-uppercase pb-2">Tourist Sign In</div>
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="password" id="exampleInputEmailAddress" class="form-control input-shadow" placeholder="Password">
                                        <div class="form-control-position">
                                ...
                                <a href="/userDash/user-dash" class="btn btn-light btn-block mt-3">Sign In</a>
                            </form>
                        </div>
                    </div>
